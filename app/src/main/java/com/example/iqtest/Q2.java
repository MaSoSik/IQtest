...
public class Q2 extends AppCompatActivity implements OnClickListener{
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            case R.id.b1:
                MainActivity.result = MainActivity.result - 50;
                break;
            case R.id.b2:
                MainActivity.result = MainActivity.result - 5;
                break;
            case R.id.b3:
                MainActivity.result = MainActivity.result + 5;
                break;
